...
describe('Graph class', () => {
  ...
  describe('removeVertex', () => {
    ...
    test('should remove a vertex with related edges', () => {
      graph.addVertex('a');
      graph.addVertex('b');
      graph.addVertex('c');
  ...
  describe('searchVertex', () => {
    test("should get an array with 'b' and 'c' vertices", () => {
      ...
      expect(graph.searchVertex('a')).toEqual(['b', 'c']);
    });
  });
  ...
  describe('findAllReachableVertices', () => {
    ...
    test('should found 5 vertices if it has self route', () => {
      ...
      expect(graph.findAllReachableVertices('a')).toEqual(['b', 'c', 'a', 'd', 'e']);
    });
  ...
  describe('findAllPaths', () => {
    test('should found 2 possible paths', () => {
      ...
      expect(graph.findAllPaths('a', 'd')).toEqual([
        ['a', 'b', 'd'],
        ['a', 'c', 'd'],
      ]);
    });
